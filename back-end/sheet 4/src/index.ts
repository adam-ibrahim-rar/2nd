...
// let mypara = document.querySelector("#paragraph") as HTMLParagraphElement;
// mypara.addEventListener("mouseover", () => {
//   for (let i = 0; i < myem.length; i++) {
//     let myElement = myem[i] as HTMLElement;
//     if (myElement) {
...
// });
// //--------------------------------------
// let options = document.querySelectorAll(".option") as NodeList;
// let inputs = document.querySelectorAll("input") as NodeList;
// for (let i = 0; i < inputs.length; i++) {
//   let myinput = inputs[i] as HTMLInputElement;
//   myinput.addEventListener("change", () => {
//     let myoption = options[0] as HTMLOptionElement;
//     for (let j = 0; j < options.length; j++) {
//       let current = options[j] as HTMLOptionElement;
//       if (current.value == myinput.id) myoption = current;
//     }
...
// let age1 = document.getElementById("age") as HTMLInputElement;
// let gpa1 = document.getElementById("gpa") as HTMLInputElement;
// let addbtn = document.getElementById("add") as HTMLButtonElement;
// let select = document.getElementById("li") as HTMLSelectElement;
// let display = document.getElementById("display") as HTMLParagraphElement;
// interface student {
//   name: string;
//   age: number;
//   gpa: number;
...
//       td1.innerText = tdname as string
//       td2.innerText = (tdgpa as number).toString()
//       td3.innerText = (tdage as number).toString()
//       tr.appendChild(td1)
//       tr.appendChild(td2)
//       tr.appendChild(td3)
